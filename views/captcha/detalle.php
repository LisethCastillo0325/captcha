...
<div class="card mt-5 mb-5">
    <div class="card-body">
        <h5 class=" textoTabla">Detalle del Captcha: <?=$this->captcha['captcha'];?></h5>
        <h6 class="card-subtitle mb-2 text-muted textoTabla">
            Título : <?= $this->captcha['titulo']; ?> | Fecha: <?= $this->captcha['fechaCreacion']; ?>
        </h6>
        <hr class="mb-5">
        <div class="accordion textoTabla" id="accordionExample">
            <?php
            $id_tabla = 0;
